...
class QuoteResponse(BaseModel):
    ...
    quote_amount: float = Field(..., description="Quote amount")
    rate: float = Field(..., description="Exchange rate")
    balam_rate: float = Field(..., description="Balam exchange rate")
    fixed_fee: float = Field(..., description="Fixed fee amount")
    pct_fee: float = Field(..., description="Percentage fee")
    ...
    network_fee: float | None = Field(None, description="Network fee for blockchain transactions")
...
class PayoutCreateRequest(BaseModel):
    ...
    amount: float = Field(..., description="Amount to be quoted")
...
class PayoutResponse(BaseModel):
    ...
    extra_info: Optional[dict] = Field(None, description="Additional information")
